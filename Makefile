...
# rm3l.org/immich-operator-v2-bundle:$VERSION and rm3l.org/immich-operator-v2-catalog:$VERSION.
IMAGE_TAG_BASE ?= rm3l.org/immich-operator-v2
...
KIND_CLUSTER ?= immich-operator-v2-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name immich-operator-v2-builder
	$(CONTAINER_TOOL) buildx use immich-operator-v2-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm immich-operator-v2-builder
	rm Dockerfile.cross
