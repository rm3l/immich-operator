...
# ghcr.io/rm3l/immich-operator-bundle:$VERSION and ghcr.io/rm3l/immich-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/rm3l/immich-operator
...
KIND_CLUSTER ?= immich-operator-test-e2e
